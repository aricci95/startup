...
class MailerService extends Service
{
    ...
    {
        // HEADERS
        $headers = 'From: "PlanSki"<contact.startup@gmail.com>' . "\n";
        $headers .='Reply-To: contact.startup@gmail.com' . "\n";
        ...
        if ($additionnalContent) {
            ...
            $content .= '<br><br>Bien cordialement, <br><br> L\'équipe <a href="http://startup.fr">PlanSki</a>.';
        }
